	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="col-xs-6">
						<a class="btn btn-default pull-left" href="/config/linkcheckerx.php?project=<?php echo MR_PROJECT; ?>" target="_blank"><i class="glyphicon glyphicon-sunglasses"></i> Launch Link Checker</a>
					</div>
