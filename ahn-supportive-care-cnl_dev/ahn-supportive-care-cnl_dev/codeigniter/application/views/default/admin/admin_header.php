				...
				<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<?php if(USER_AUTHENTICATION_REQUIRED || (!USER_AUTHENTICATION_REQUIRED && is_admin())): ?>
								...
								<?php if (is_admin()): ?>
									...
									<li><a	href="javascript:MR.utils.link('admin/term_definitions');"><i class="glyphicon glyphicon-list-alt"></i> Term Definitions</a></li>
								<?php endif; ?>
							</ul>
						</li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<?php /* Hide experience link for Admins */
								if (!(!USER_AUTHENTICATION_REQUIRED &&
										MR_HAS_SPEAKER &&
										is_logged_in() &&
										!is_anonymous_guest_user())) : ?>
									<li><a href="javascript:MR.utils.link('/');"><i class="glyphicon glyphicon-tasks"></i> View App</a></li>
								<?php endif; ?>
