			...
			<div class="modal-content" ng-model="new_user">
				...
				<div class="modal-body">
					<form class="form-horizontal" autocomplete="off">
						...
						<div ng-repeat="level in organization_hierarchy.form.levels[new_user.organization_id]" ng-show="show_form_organization_hierarchy_level_dropdown('new_user', new_user.user_type_id, new_user.organization_id, level)" class="form-group">
							<div ng-if="level.multi_sibling_membership_allowed == 1">
								<label class="col-sm-4 control-label">{{level.organization_hierarchy_level_name}}:</label>
								<div class="col-sm-6">
									<select multiple class="form-control" ng-model="organization_hierarchy.form.selected_element_ids.new_user[level.organization_hierarchy_level_id]"
										ng-options="element.organization_hierarchy_level_element_id as element.organization_hierarchy_level_element_name for element in elements = (get_form_organization_hierarchy_level_elements('new_user', new_user.user_type_id, new_user.organization_id, level))">
									</select>
								</div>
							</div>
							<div ng-if="level.multi_sibling_membership_allowed == 0">
								<label class="col-sm-4 control-label">{{level.organization_hierarchy_level_name}}:</label>
								<div class="col-sm-6">
									<select class="form-control" ng-model="organization_hierarchy.form.selected_element_ids.new_user[level.organization_hierarchy_level_id]"
										ng-options="element.organization_hierarchy_level_element_id as element.organization_hierarchy_level_element_name for element in elements = (get_form_organization_hierarchy_level_elements('new_user', new_user.user_type_id, new_user.organization_id, level))">
									</select>
								</div>
							</div>
			...
			<div class="modal-content" ng-model="existing_user">
				...
				<div class="modal-body">
					...
					<?php endif; ?>
						...
						<div ng-repeat="level in organization_hierarchy.form.levels[existing_user.organization_id]" ng-show="show_form_organization_hierarchy_level_dropdown('existing_user', existing_user.user_type_id, existing_user.organization_id, level)" class="form-group">
							<div ng-if="level.multi_sibling_membership_allowed == 1">
								<label class="col-sm-4 control-label">{{level.organization_hierarchy_level_name}}:</label>
								<div class="col-sm-6">
									<select multiple class="form-control" ng-model="organization_hierarchy.form.selected_element_ids.existing_user[level.organization_hierarchy_level_id]"
										ng-options="element.organization_hierarchy_level_element_id as element.organization_hierarchy_level_element_name for element in elements = (get_form_organization_hierarchy_level_elements('existing_user', existing_user.user_type_id, existing_user.organization_id, level))">
									</select>
								</div>
							</div>
							<div ng-if="level.multi_sibling_membership_allowed == 0">
								<label class="col-sm-4 control-label">{{level.organization_hierarchy_level_name}}:</label>
								<div class="col-sm-6">
									<select class="form-control" ng-model="organization_hierarchy.form.selected_element_ids.existing_user[level.organization_hierarchy_level_id]"
										ng-options="element.organization_hierarchy_level_element_id as element.organization_hierarchy_level_element_name for element in elements = (get_form_organization_hierarchy_level_elements('existing_user', existing_user.user_type_id, existing_user.organization_id, level))">
									</select>
								</div>
							</div>
