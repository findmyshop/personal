<div class="col-md-6 col-md-offset-3">
	...
	<div class="panel-heading"><h3 class="text-muted" id="mr-login-title">Sign In</h3></div>
		<form autocomplete="off" class="form-signin panel-body" method="POST" onsubmit="return false">
			...
			<div class="form-group">
				<div class="input-group input-group-lg">
					...
					<input id="username" title="Username" name="username" type="text" class="form-control" placeholder="Username" required autofocus >
		...
		<br/>
		<a class="pull-left" id="mr-login-forgot" href="javascript:MR.utils.link('login/forgot_password');">Forgot Password?</a>
	</form>
</div>
</div>
