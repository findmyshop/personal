	...
	<div class="modal-dialog">
		<div class="modal-content" ng-model="modal">
			...
			<div class="modal-body">
				<p>Welcome to the Supportive Care Options Program. The goal of the program is to reinforce the information provided during a supportive care consultation.</p>
				<p>The program provides a guided discussion of supportive care options (click Review Options on the 3rd screen) or you may ask questions (click Ask a Question). We would appreciate your reviewing options, asking questions and then, giving us your feedback by clicking on "Give Us Your Feedback" under the Resources tab.</p>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="disclaimer-text">
					Welcome to the Supportive Care Resource Center. The answers in this site have been researched, and we hope they offer you the information you desire, but if you have greater need of knowledge, please contact our Supportive Care Team at 412-578-6958, or your physician.
				</p>
			</div>
			<div class="modal-footer">
