	...
	<div>
		...
		<div id="mr-ct-login-instructions-wrapper" class="mr-is-wrapper">
			<div class="mr-is-scroller">
				<p>
					Thank you for your interest in the NODE-1 clinical research study.
	...
	<form autocomplete="off" class="form-signin panel-body" method="POST" onsubmit="return false">
		...
		<div class="row" style="text-align:center;">
			<div style="display:inline-block; vertical-align:middle;" class="form-group">
				<button style="padding-left:50px;padding-right:50px;" title="Sign In" class="btn btn-lg btn-primary" type="submit" id="mr-sign-in" onclick="MMG.login.checkOptions(false);">Enter Site</button>
			</div>
		</div>
	</form>
