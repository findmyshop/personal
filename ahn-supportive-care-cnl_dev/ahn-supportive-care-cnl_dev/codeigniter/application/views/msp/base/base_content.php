<div id="mr-col-left" class="col-xs-3 mr-col">
	<div class="mr-widget mr-button-widget">
		<a class="btn btn-primary btn-block" href="https://clinicaltrials.gov/ct2/show/study/NCT02296190?term=psvt+milestone&rank=1" target="_blank">This study is listed on ClinicalTrials.gov</a>
	</div>
	<div class="mr-widget">
		<div class="panel-heading" style="background:#fff;font-weight:bold;">Frequently Asked Questions:</div>
	</div>
	<?php get_left_rail(); ?>
</div><!--/.mr-col-->
