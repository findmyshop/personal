...
<div class="col-xs-6 align-center col-2 mr-col ct-login-col">
	...
	<div id="agreement-text" class="mr-is-wrapper">
		<div class="mr-is-scroller">
			<h4>Terms of Use</h4>
			<p>Welcome! This website is operated by Merck, the sponsor of the APECS study for prodromal Alzheimer’s disease.</p>
			...
			<p>The videos on this site portray actors and actresses, not actual medical personnel.</p>
			<p>The content of the pages of this website, including questions and answers is for your general information and use only. It is subject to change without notice.</p>
			<p>This site is not intended to provide medical advice. Any answers provided on this site are not intended to replace a conversation with your personal doctor or a study doctor.</p>
			<p>Any specific questions about your health or participation in a clinical research study should be directed to your doctor, a study doctor, or another member of the study team.</p>
			<p>This website is not intended for reporting adverse events or product complaints.</p>
		</div>
	</div>
