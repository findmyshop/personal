	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="mr-navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
					<li>
						<a class="top-nav-button"	target="_blank" href="http://upci.upmc.edu/wcrc/patientAdvocacy.cfm"><i class="icon glyphicon glyphicon-home"></i> Home</a>
					</li>
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a target="_blank" href="http://upci.upmc.edu/wcrc/patientAdvocacy.cfm"><i class="glyphicon glyphicon-file"></i>Breast Cancer Research Advocacy Network</a></li>
							<li><a target="_blank" href="https://clinicaltrials.gov/"><i class="glyphicon glyphicon-file"></i>Find a Clinical Trial</a></li>
							<li><a target="_blank" href="https://www.breastcancertrials.org/BCTIncludes/FindATrial/QuestionsForDoctors.html"><i class="glyphicon glyphicon-file"></i>Doctor Discussion Checklist</a></li>
