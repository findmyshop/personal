...
<div class="navbar navbar-default learn-nav" role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand fake-active" href="<?=get_link('home')?>"><?=$page['title']?> | Helpline: 1-800-523-5933</a>
		</div>
		<div class="collapse navbar-collapse" id="mr-navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
					<li>
						<a class="top-nav-button"	target="_blank" href="http://www.namisandiego.org"><i class="icon glyphicon glyphicon-home"></i> Home</a>
					</li>
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="https://namisandiego.org/contact/" target="_blank"><i class="glyphicon glyphicon-bullhorn"></i> Contact NAMI San Diego</a></li>
							<li><a href="javascript:MR.modal.show('#bug-modal');"><i class="glyphicon glyphicon-bullhorn"></i> Contact Technical Support</a></li>
