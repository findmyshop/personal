...
'ng_action' => 'data-toggle="modal" load-user data-target="#edit_user_modal"',
	'columns' => array(
		...
		array('title' => 'Branch Or Service Market', 'ng_data' => 'department_name'),
				 ...
				 <!--	 ==================== ADD FORM - START ============================= -->
					<form class="form-horizontal" role="form" autocomplete="off">
						<div class="form-group">
							<div class="col-sm-4">
								<label for="department_id" class="control-label">Branch:</label>
							</div>
							<div class="col-sm-3">
								<select class="form-control" ng-model="new_user.department_id" id="department_id" name="department_id">
									<option value="-1">-- Select Branch or Service Market--</option>
						...
						<div class="form-group" ng-show="show_all_add_form_fields">
							 <div class="col-sm-4">
								 <label for="dod_number" class="control-label">DOD #:</label>
							 </div>
							<div class="col-sm-4">
								<input type="text" ng-model="new_user.dod_number" class="form-control" id="dod_number" name="dod_number" placeholder="DOD #">
							</div>
							<div class="col-sm-4" style="color: orange;">
								* DOD number has ten digits.
							</div>
						</div>

						<div class="form-group" class="col-sm-4" ng-show="show_all_add_form_fields">
								<div class="col-sm-4">
									<label for="first_name" class="control-label">Pay Grade:</label>
								</div>
								<div class="col-sm-4" >
									<select class="form-control" ng-model="new_user.pay_grade_id" id="pay_grade_id" name="pay_grade_id">
										<option value="-1">-- Select Pay Grade --</option>
						...
						<div class="form-group" ng-show="show_all_add_form_fields">
							<div class="col-sm-4">
								<label for="treatment_facility_id" class="control-label">Treatment Facility:</label>
							</div>
							<div class="col-sm-4">
								<select class="form-control" ng-model="new_user.treatment_facility_id" id="treatment_facility_id" name="treatment_facility_id">
									<option value="-1">-- Select Treatment Facility --</option>
						...
						<div class="form-group" ng-show="show_all_add_form_fields">
							<div class="col-sm-4">
									<label for="city_state_zip" class="control-label">Country:</label>
								</div>
							<div class="col-sm-4">
									<select class="form-control" ng-model="new_user.country_id" id="country_id" name="country_id" add-user-country-changed>
						...
						<div class="form-group" ng-show="show_all_add_form_fields">
							<div class="col-sm-4" ng-show="us_address_on_add_form">
								<label for="city_state_zip" class="control-label">City, State, Zip:</label>
							</div>
							<div class="col-sm-4" ng-show="!us_address_on_add_form">
								<label for="city_state_zip" class="control-label">City, Province, Postal Code:</label>
							</div>
							<div class="col-sm-2" >
								<input type="text" ng-model="new_user.city" class="form-control" id="city" name="city" placeholder="City">
							</div>
							<div class="col-sm-2" ng-show="us_address_on_add_form" style="padding:0;">
								...
								<div class="col-sm-2" ng-show="!us_address_on_add_form" style="padding:0;">
									<input type="text" ng-model="new_user.province" class="form-control" id="province" name="province" placeholder="Province">
								</div>
								<div class="col-sm-2" >
		...
		<div class="modal-dialog">
			...
			<!--	==================== EDIT FORM - START ============================= -->
					<form class="form-horizontal" role="form" autocomplete="off">
						<div class="form-group">
							<div class="col-sm-4">
								<label for="department_id" class="control-label">Branch or Service Market:</label>
							</div>
							<div class="col-sm-3">
								<select class="form-control" ng-model="existing_user.department_id" id="department_id" name="department_id">
									<option value="-1">-- Select Branch or Service Market --</option>
									<option ng-repeat="department in departments" ng-cloak ng-selected value="{{department.id}}">{{department.department_name}}</option>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control" ng-model="existing_user.user_type_id" id="user_type_id" name="user_type_id" edit-user-select-type-changed>
									<option value="-1">-- Select User Type --</option>
									<option ng-repeat="user_type in user_types" ng-cloak value="{{user_type.id}}">{{user_type.type_name}}</option>
								</select>
							</div>
						...
						<div class="form-group">
						 ...
						 <div class="form-group"	ng-show="show_all_edit_form_fields">
							...
							<div class="col-sm-4">
								<input type="text" ng-model="existing_user.dod_number" class="form-control" id="dod_number" name="dod_number" placeholder="DOD #">
							</div>
							<div class="col-sm-4" style="color: orange;">
								* DOD number has ten digits
							</div>
			...
			<div class="form-group" ng-show="show_all_edit_form_fields">
							<div class="col-sm-4">
								<label for="pay_grade_id" class="control-label">Pay Grade:</label>
							</div>
								<div class="col-sm-3">
									<select class="form-control" ng-model="existing_user.pay_grade_id" id="pay_grade_id" name="pay_grade_id">
										<option value="-1">-- Select Pay Grade --</option>
											<option ng-repeat="pay_grade in pay_grades" ng-cloak ng-selected value="{{pay_grade.id}}">{{pay_grade.pay_grade_name}}</option>
									</select>
								</div>
						...
						<div class="form-group" ng-show="show_all_edit_form_fields">
							...
							<div class="col-sm-4">
								<select class="form-control" ng-model="existing_user.treatment_facility_id" id="treatment_facility_id" name="treatment_facility_id">
									<option value="-1">-- Select Treatment Facility --</option>
									<option ng-repeat="treatment_facility in treatment_facilities" ng-cloak ng-selected value="{{treatment_facility.id}}">{{treatment_facility.department_name}} - {{treatment_facility.treatment_facility}}</option>
								</select>
							</div>
						...
						<div class="form-group"	 ng-show="show_all_edit_form_fields">
							...
							<div class="col-sm-3">
								<select class="form-control" ng-model="existing_user.role_id" id="role_id" name="role_id">
								<option value="-1">-- Select Role --</option>
									<option ng-repeat="role in roles" ng-cloak ng-selected value="{{role.id}}">{{role.role_name}}</option>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" ng-model="existing_user.email_address" class="form-control" id="email_address" name="email_address" placeholder="Email Address">
							</div>
						</div>
						...
						<div class="form-group" ng-show="show_all_edit_form_fields">
							...
							<div class="col-sm-4">
									<select class="form-control" ng-model="existing_user.country_id" id="country_id" name="country_id" edit-user-country-changed>
										<option value="-1">-- Select Country --</option>
											<option ng-repeat="country in countries" ng-cloak ng-selected value="{{country.country_id}}">{{country.name}}</option>
									</select>
								</div>
						...
						<div class="form-group" ng-show="show_all_edit_form_fields">
							<div class="col-sm-4" ng-show="us_address_on_edit_form">
									<label for="city_state_zip" class="control-label">City, State, Zip:</label>
								</div>
								<div class="col-sm-4" ng-show="!us_address_on_edit_form">
									<label for="city_state_zip" class="control-label">City, Province, Postal Code:</label>
								...
								<div class="col-sm-2" ng-show="us_address_on_edit_form" style="padding:0;">
								...
								<div class="col-sm-2" ng-show="!us_address_on_edit_form" style="padding:0;">
									<input type="text" ng-model="existing_user.province" class="form-control" id="province" name="province" placeholder="Province">
								</div>
								<div class="col-sm-2">
