	...
	<div class="panel-heading">
		...
		<div class="col-xs-6">
			<span class="input-group-btn input-group-sm">
				<select class="form-control" ng-model="statistics_filter_department_id" name="statistics_filter_department_id">
			...
			<span class="input-group-btn input-group-sm">
				<select class="form-control" ng-model="statistics_filter_treatment_facility_id" name="statistics_filter_treatment_facility_id">
					<option value="-1">All Treatment Facilities</option>
		...
		<?php foreach($courses as $course): ?>
			<div id="<?= $course ?>_course" ng-cloak ng-show="statistics_filter_course == '<?= $course ?>_course'">
				...
				<div class="tab-content col-xs-8" id="test-print-panel">
					...
					<div role="tabpanel" class="tab-pane" id="t4-'.$course.'">
			...
			<?= build_shell_panel(array(
				'title'	=> ($course === 'alcohol_sbirt_one_hour') ? 'Course: AlcoholSBIRT 1 Hour ' : 'Course: AlcoholSBIRT 3 Hour',
				'body'	=> $panel_body
			)); ?>
			</div>
		<?php endforeach; ?>
