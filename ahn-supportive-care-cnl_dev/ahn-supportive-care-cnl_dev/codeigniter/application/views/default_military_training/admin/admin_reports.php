	...
	<div class="panel-heading">
		...
		<div class="input-group input-group-sm col-xs-5">
			<span class="input-group-btn input-group-sm">
				<select class="form-control" ng-model="course_search_department_id" name="course_search_department_id">
			...
			<span class="input-group-btn input-group-sm">
				<select class="form-control" ng-model="course_search_treatment_facility_id" name="course_search_treatment_facility_id">
			...
			<span class="input-group-btn input-group-sm">
				<select class="form-control" ng-model="course_search_role_id" name="course_search_role_id">
