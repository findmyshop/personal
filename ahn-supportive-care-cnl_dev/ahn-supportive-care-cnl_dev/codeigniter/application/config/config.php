...
$config['encryption_key'] = 'faba68975ed69f25b785c12785fd0002';
...
} else if(MR_PROJECT === 'pra' || MR_PROJECT === 'prb' || MR_PROJECT === 'prc') {
...
$config['sess_time_to_update'] = PHP_INT_MAX; // do not update sessions.  doing so leads to dropped sessions with concurrent ajax requests
